...
if (process.env.NEXT_PUBLIC_NODE_ENV == "production") {
  api =
    "https://seahorse-app-pir2f.ondigitalocean.app/api/estore/create-thumbnail-estore-product-web";
} else if (process.env.NEXT_PUBLIC_NODE_ENV == "development") {
  api = "http://localhost:8000/api/estore/create-thumbnail-estore-product-web";
}
              ...
              products.map((product) => (
                <div key={product.id} style={styles.productCard}>
                  ...
                  <div style={styles.displayFlex}>
                    ...
                    {product.thumbnailPresent ? (
                      <button
                        style={styles.editButton1}
                        onClick={() => handleGotThumbnail(product.id)}
                      >
                        Thumbnail Present
                      </button>
                    ) : (
