...
export const ongoingOrdersEstore = async () => {
  ...
  console.log("results ggg estore", results);
  ...
  console.log("estore arrya", estoresResultArray[9]);
  ...
  console.log("data sent", dataEstore);
...
export const ordersHistoryEstores = async () => {
  ...
  console.log("results ggg estore", results.length);
